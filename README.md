...
```text
to-java.xsl              95775  37.95%
classes.xsl              85196  33.76%
set-locators.xsl         20207  8.01%
set-original-names.xsl   13479  5.34%
attrs.xsl                9333   3.70%
data.xsl                 8542   3.38%
anonymous-to-nested.xsl  6802   2.70%
package.xsl              6779   2.69%
tests.xsl                6243   2.47%
```

The results were calculated in [this GHA job][benchmark-gha]
on 2025-10-07 at 21:39,
on Linux with 4 CPUs.
The total is 252356 milliseconds.
...
[benchmark-gha]: https://github.com/default-writer/eo/actions/runs/18326722590
